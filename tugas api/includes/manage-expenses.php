...
<body>
  ...
  <div class="logo-details">
      ...
      <span class="logo_name">Catatduit</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="home.php" >
  ...
  <section class="home-section">
    ...
    <div class="sidebar-button">
        ...
        <span class="dashboard">Catatduit</span>
      </div>
                                        ...
                                        ?>
                                          ...
                                          <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editExpenseModal-<?php echo $row['ID']; ?>"><i class="fas fa-edit"></i> Edit</a>
